...
Proves the rebuilt gate-step widgets (sync, focus/exposure, overlap, coarse
rectification) and the quality report drive the tested
:class:`SetupStateMachine` over the canonical 9-step :data:`DEFAULT_SETUP_SPEC`,
including skipping the optional ChArUco fine-tune step and still finishing.
"""
