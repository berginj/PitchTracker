...
class TestPatternDetectionIntegration(unittest.TestCase):
    ...
    def _create_session_summary(self, pitches_data):
        ...
        session_data = {"session_id": "test_session", "created_utc": "2026-01-19T12:00:00Z", "pitches": pitches_data}
    ...
    def test_analyze_session_end_to_end(self):
        ...
        report = detector.analyze_session(self.session_dir, pitcher_id=None, output_json=True, output_html=True)
    ...
    def test_analyze_session_with_baseline(self):
        ...
        report = detector.analyze_session(
            self.session_dir, pitcher_id="test_pitcher", output_json=True, output_html=False
        )
