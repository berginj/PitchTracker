...
class CalibrationStepPanelsMixin(CalibrationStepMixinHost):
    def _build_settings_group(self) -> QtWidgets.QWidget:
        ...
        self._swap_lr_btn = QtWidgets.QPushButton("Swap Left / Right")
    ...
    def _build_alignment_widget(self) -> QtWidgets.QGroupBox:
        ...
        self._compare_preset_btn = QtWidgets.QPushButton("Compare")
