...
class CoachWindow(QtWidgets.QMainWindow):
    ...
    def _build_controls(self) -> QtWidgets.QWidget:
        ...
        self._setup_button.setMinimumHeight(self._style_manager.theme.button_height_lg)
        ...
        self._start_recording_button.setMinimumHeight(self._style_manager.theme.button_height_lg)
        ...
        self._pause_button.setMinimumHeight(self._style_manager.theme.button_height_lg)
        ...
        self._end_button.setMinimumHeight(self._style_manager.theme.button_height_lg)
        ...
        self._settings_button.setMinimumHeight(self._style_manager.theme.button_height_lg)
        ...
        self._lane_button.setMinimumHeight(self._style_manager.theme.button_height_lg)
        ...
        self._review_button.setMinimumHeight(self._style_manager.theme.button_height_lg)
        ...
        self._help_button.setMinimumHeight(self._style_manager.theme.button_height_lg)
