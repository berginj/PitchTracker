"""Internal alignment primitives shared by the public camera_alignment API.

Low-level building blocks: feature matching and the per-dimension analysis,
quality, and message helpers. IO-free and UI-free.
"""
